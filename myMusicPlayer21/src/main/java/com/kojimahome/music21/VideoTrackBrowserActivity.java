...
public class VideoTrackBrowserActivity extends ListActivity
...
//    private String mGenre;
    ...
    public VideoTrackBrowserActivity()
    {
    }
...
//                MediaStore.Video.Media.ARTIST_ID,
...
//        mToken = MusicUtils.bindToService(this, this);
        ...
        try {
        	...
        	if (oldVersionCode == 0) {
        		...
        		Intent intent2 = new Intent();
		        intent2.setClass(this, NewFeaturesActivity.class);
		        startActivity(intent2);
		        MusicUtils.setIntPref(this, "versioncode", versionCode);
        	}
    ...
    private BroadcastReceiver mScanListener = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (Intent.ACTION_MEDIA_SCANNER_STARTED.equals(action) ||
                ...
                MusicUtils.setSpinnerState(VideoTrackBrowserActivity.this);
            }
...
//            if (key != null) {
////                int keyidx = mTrackCursor.getColumnIndexOrThrow(MediaStore.Video.Media.ARTIST_ID);
...
//        }
    ...
    private void setAlbumArtBackground() {
        try {
            ...
            Bitmap bm = MusicUtils.getArtwork(VideoTrackBrowserActivity.this, -1, albumid, false);
            if (bm != null) {
    ...
    private void setTitle() {
        ...
        if (mAlbumId != null) {
            ...
            if (numresults > 0) {
                mTrackCursor.moveToFirst();
                int idx = mTrackCursor.getColumnIndexOrThrow(MediaStore.Video.Media.ALBUM);
                ...
                String where = "";
//                String where = MediaStore.Video.Media.ALBUM_ID + "='" + mAlbumId +
//                        "' AND " + MediaStore.Video.Media.ARTIST_ID + "=" + 
//                        mTrackCursor.getLong(mTrackCursor.getColumnIndexOrThrow(
//                                MediaStore.Video.Media.ARTIST_ID));
                Cursor cursor = MusicUtils.query(this, MediaStore.Video.Media.EXTERNAL_CONTENT_URI,
                    new String[] {MediaStore.Video.Media.TITLE}, null, null, null);
                if (cursor != null) {
...
//        	if (mGenre != null) {
//            String [] cols = new String [] {
//            MediaStore.Video.Genres.NAME
//            };
//            Cursor cursor = MusicUtils.query(this,
//                    ContentUris.withAppendedId(MediaStore.Video.Genres.EXTERNAL_CONTENT_URI, Long.valueOf(mGenre)),
//                    cols, null, null, null);
//            if (cursor != null) {
//                if (cursor.getCount() != 0) {
//                    cursor.moveToFirst();
...
//            getListView().invalidateViews();
//            if (!mEditMode) {
//                MusicUtils.updateNowPlaying(VideoTrackBrowserActivity.this);
//            }
//        }
//    };
...
//        int titleidx = c.getColumnIndex(MediaStore.Video.Media.TITLE);
//        int albumidx = c.getColumnIndex(MediaStore.Video.Media.ALBUM);
//        int artistidx = c.getColumnIndex(MediaStore.Video.Media.ARTIST);
//
...
//        int ismusic_idx = c.getColumnIndex(MediaStore.Video.Media.IS_MUSIC);
    ...
    public boolean onContextItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case PLAY_SELECTION: {
                ...
                String type = mTrackCursor.getString(mTrackCursor.getColumnIndexOrThrow(MediaStore.Video.Media.MIME_TYPE));
                long id = mTrackCursor.getLong(mTrackCursor.getColumnIndexOrThrow(MediaStore.Video.Media._ID));
...
//            if (MusicUtils.sService != null) {
//                try {
//                	MusicUtils.sService.clearABPos();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case SHUFFLE_ALL:
                ...
                cursor = MusicUtils.query(this, MediaStore.Video.Media.EXTERNAL_CONTENT_URI,
                        new String [] { MediaStore.Video.Media._ID}, 
//                        MediaStore.Video.Media.IS_MUSIC + "=1", null,
                        null, null,
    ...
    private Cursor getTrackCursor(TrackListAdapter.TrackQueryHandler queryhandler, String filter,
        ...
        Cursor ret = null;
//        mSortOrder = MediaStore.Video.Media.TITLE_KEY;
        mSortOrder = MediaStore.Video.Media.TITLE;
...
//                String key = MediaStore.Video.keyFor(searchWords[i]);
//                key = key.replace("\\", "\\\\");
//                key = key.replace("%", "\\%");
//                key = key.replace("_", "\\_");
//                keywords[i] = '%' + key + '%';
...
//            for (int i = 0; i < searchWords.length; i++) {
//                where.append(" AND ");
//                where.append(MediaStore.Video.Media.ARTIST_KEY + "||");
//                where.append(MediaStore.Video.Media.TITLE_KEY + " LIKE ? ESCAPE '\\'");
//            }
        }
        
//        if (mGenre != null) {
//            mSortOrder = MediaStore.Video.Genres.Members.DEFAULT_SORT_ORDER;
//            ret = queryhandler.doQuery(MediaStore.Video.Genres.Members.getContentUri("external",
...
//        } else {
//            if (mAlbumId != null) {
//                where.append(" AND " + MediaStore.Video.Media.ALBUM_ID + "=" + mAlbumId);
//                mSortOrder = MediaStore.Video.Media.TRACK + ", " + mSortOrder;
//            }
//            if (mArtistId != null) {
//                where.append(" AND " + MediaStore.Video.Media.ARTIST_ID + "=" + mArtistId);
//            }
//            where.append(" AND " + MediaStore.Video.Media.IS_MUSIC + "=1");
            ret = queryhandler.doQuery(MediaStore.Video.Media.EXTERNAL_CONTENT_URI,
                    mCursorCols, where.toString() , keywords, mSortOrder, async);
//        }
    ...
    private class NowPlayingCursor extends AbstractCursor
    {
        ...
        private void makeNowPlayingCursor() {
            ...
            mCurrentPlaylistCursor = MusicUtils.query(VideoTrackBrowserActivity.this,
                    MediaStore.Video.Media.EXTERNAL_CONTENT_URI,
                    mCols, where.toString(), null, MediaStore.Video.Media._ID);
            ...
            int colidx = mCurrentPlaylistCursor.getColumnIndexOrThrow(MediaStore.Video.Media._ID);
    ...
    static class TrackListAdapter extends SimpleCursorAdapter implements SectionIndexer {
        ...
        private VideoTrackBrowserActivity mActivity = null;
        ...
        TrackListAdapter(Context context, VideoTrackBrowserActivity currentactivity,
        ...
        public void setActivity(VideoTrackBrowserActivity newactivity) {
        ...
        private void getColumnIndices(Cursor cursor) {
            if (cursor != null) {
                mTitleIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media.TITLE);
                mArtistIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media.ARTIST);
                mDurationIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DURATION);
                mDateTakenIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media.DATE_TAKEN);
                mVideoIdIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media._ID);
//                try {
//                    mAudioIdIdx = cursor.getColumnIndexOrThrow(
//                            MediaStore.Video.Playlists.Members.AUDIO_ID);
//                } catch (IllegalArgumentException ex) {
//                    mAudioIdIdx = cursor.getColumnIndexOrThrow(MediaStore.Video.Media._ID);
//                }
...
//            builder.append(MusicUtils.makeDateTimeString(context, secs));
//            if (name == null) {
...
//            vh.line2.setText(vh.buffer2, 0, len);
            ...
            final int id = cursor.getInt(mVideoIdIdx);
//            ImageView iv = (ImageView ) convertView.findViewById(R.id.imagePreview);
            final ContentResolver crThumb = context.getContentResolver();
            final BitmapFactory.Options options=new BitmapFactory.Options();
            options.inSampleSize = 1;
//            final Bitmap curThumb = MediaStore.Video.Thumbnails.getThumbnail(crThumb, id, MediaStore.Video.Thumbnails.MICRO_KIND, options);
...
//            iv.setVisibility(android.view.View.VISIBLE);
          ...
          final StringBuilder builder = mBuilder;
          builder.delete(0, builder.length());
          long longsecs = cursor.getLong(mDateTakenIdx) / 1000;
          String name = cursor.getString(mArtistIdx);
          String datataken = MusicUtils.makeDateTimeString(context, longsecs);
          builder.append(datataken);
          if (name == null) {
              builder.append(mUnknownArtist);
          } else {
              builder.append(name);
