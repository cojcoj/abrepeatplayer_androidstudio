...
public class ID3v2LyricFrameData extends AbstractID3v2FrameData {
	...
	public ID3v2LyricFrameData(boolean unsynchronisation) {
		super(unsynchronisation);
	}

	public ID3v2LyricFrameData(boolean unsynchronisation, String language, EncodedText description, EncodedText comment) {
		super(unsynchronisation);
	...
	public ID3v2LyricFrameData(boolean unsynchronisation, byte[] bytes) throws InvalidDataException {
		super(unsynchronisation);
...
//			length++;
//		}
		length = bytes.length - marker;  //test
	...
	public boolean equals(Object obj) {
		if (! (obj instanceof ID3v2LyricFrameData)) return false;
		if (! super.equals(obj)) return false;
		ID3v2LyricFrameData other = (ID3v2LyricFrameData) obj;
		if (language == null) {
