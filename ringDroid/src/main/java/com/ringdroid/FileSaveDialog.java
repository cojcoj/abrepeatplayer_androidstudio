...
public class FileSaveDialog extends Dialog {
    ...
    public static final int FILE_KIND_ANKIDROID = 4;
    ...
    public FileSaveDialog(Context context,
        ...
        mTypeArray.add(resources.getString(R.string.type_ankidroid));
        ...
        prefs = context.getSharedPreferences("RingdroidEditActivity",Context.MODE_PRIVATE);
        int kind = prefs.getInt(FILE_KIND, FILE_KIND_RINGTONE);
        
        mTypeSpinner.setSelection(kind);
        mPreviousSelection = kind;
    ...
    private View.OnClickListener saveListener = new View.OnClickListener() {
            public void onClick(View view) {
                ...
                prefsEditor.putInt(FILE_KIND, mResponse.arg1);
                prefsEditor.commit();
